...
public class ModEntities {
    ...
    public static DeferredHolder<EntityType<?>, EntityType<StickyGrenadeEntity>> STICKY_GRENADE = ENTITY_TYPES.register("sticky_grenade_entity", () -> StickyGrenadeEntity.TYPE);
