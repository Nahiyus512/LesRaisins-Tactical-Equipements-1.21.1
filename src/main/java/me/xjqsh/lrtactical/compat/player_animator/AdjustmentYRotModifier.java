...
public class AdjustmentYRotModifier implements Function<String, Optional<AdjustmentModifier.PartModifier>> {
    ...
    public Optional<AdjustmentModifier.PartModifier> apply(String partName) {
        ...
        float yaw = Mth.clamp(Mth.wrapDegrees(yHeadRot - yBodyRot), -85f, 85f);
        ...
        return switch (partName) {
            ...
            case "leftArm", "rightArm" -> Optional.of(new AdjustmentModifier.PartModifier(new Vec3f(Mth.clamp(pitch, -15f, 15f) * Mth.DEG_TO_RAD, 0, 0), Vec3f.ZERO));
